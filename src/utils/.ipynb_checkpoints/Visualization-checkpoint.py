...
def calculate_preferential_attachment(G, subset_size = 350, seed=1):
    ############ Connected Nodes ############
...
def calculate_common_neighbors(G, subset_size=350, seed=1):
    ############ Connected Nodes ############
...
def calculate_jaccards_coeff(G, subset_size = 350, seed=1):
    ############ Connected Nodes ############
    G_connected_undirected = G.to_undirected()
...
def calculate_adamic_adar(G, subset_size = 350, seed=1):
    ############ Connected Nodes ############
    G_connected_undirected = G.to_undirected()
